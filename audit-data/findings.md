...
### [G-1] `L1Vault::token` variable can be marked `immutable` to save storage and gas
...
### [G-2] Functions can be marked external instead of public to optimize gas
...
### [G-3] `L1BossBridge::DEPOSIT_LIMIT` should be marked `constant` to save storage and gas
